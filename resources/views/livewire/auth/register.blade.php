                ...
                <div
                    ...
                    <div class="grow p-5 md:px-16 md:py-12">
                        <form class="space-y-6" wire:submit='register'>
                            ...
                            <div class="space-y-1">
                                <label for="password_confirmation" class="text-sm font-medium">Password
                                    confirmation</label>
                    ...
                    <div class="grow bg-gray-50 p-5 text-center text-sm dark:bg-gray-700/50 md:px-16">
                        ...
                        <a wire:navigate href="{{ route('login') }}"
                            class="font-medium text-blue-600 hover:text-blue-400 dark:text-blue-400 dark:hover:text-blue-300">Login</a>
                    </div>
                </div>
                <!-- END Sign In Form -->
